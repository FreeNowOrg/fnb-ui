...
//
// Output is piped through Prettier before writing so the generated files
// always match `pnpm format:check` — without this, any token value long
...
await writeFormatted('src/styles/_breakpoints.scss', scss)
